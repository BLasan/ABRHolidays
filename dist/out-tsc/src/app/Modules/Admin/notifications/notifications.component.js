...
var NotificationsComponent = /** @class */ (function () {
    function NotificationsComponent(toastr, _db) {
        this.toastr = toastr;
        this._db = _db;
    ...
    NotificationsComponent.prototype.create_alerts = function (name) {
    ...
    NotificationsComponent.prototype.open_modal = function (id) {
        this.filtered_data = [];
    ...
    NotificationsComponent = tslib_1.__decorate([
        ...
        tslib_1.__metadata("design:paramtypes", [ToastrService, AngularFirestore])
